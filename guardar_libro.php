...
if (isset($_POST['titulo']) && isset($_POST['autor']) && isset($_POST['descripcion']) && isset($_POST['existencia']) && isset($_POST['fecha_publicacion'])) {
    ...
    if ($existencia_actual !== null) {
        ...
        $insert_stmt = $conex->prepare("INSERT INTO Libros (titulo, autor, descripcion, existencia, fecha_de_publicacion, portada) VALUES (?, ?, ?, ?, ?, ?)");
        
        // Usamos "b" (binary) en el bind_param para manejar los datos binarios
        $insert_stmt->bind_param("sssisb", $titulo, $autor, $descripcion, $existencia, $fecha_publicacion, $portada);
